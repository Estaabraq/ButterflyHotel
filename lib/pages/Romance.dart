  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Romance Alexandria Hotel' ),
        centerTitle: true,
      ),
      body:
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            buildText("Standing on the Mediterranean shore in Alexandria, this 4-star hotel is situated in the elegant Saba Pasha district. All rooms host panoramic sea views and there are 2 gourmet restaurants to choose from."
                                "Romance Alexandria Hotel offers spacious accommodation with carpet floors, wide floor-to-ceiling windows, and light neutral colours. Each room has satellite TV and a minibar.\n"
                                ...
                                "Romance Alexandria Hotel is located 1 km from the Stanley Bay beach area. Alexandria El Nohza Airport is 10 km away.."
